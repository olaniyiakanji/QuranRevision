    ...
    <section id="about" className="section">
      <div className="about-wrap">
        <div className="about-left fade-up">
          <span className="sec-label">About the Event</span>
          <h2 className="sec-title">A sacred day for the<br /><em>huffaz of Nigeria</em></h2>
          <div className="about-divider" />
          <p className="about-body">
            Qur&rsquo;an Revision Day is a <strong>full-day, pre-Ramadan gathering</strong> where huffaz and memorizers of the Qur&rsquo;an come together in one sitting to revise from memory &mdash; strengthening their hearts before the blessed month arrives.
          </p>
          <p className="about-body">
            Inspired by the annual programme held at <em>East London Mosque</em> since 2022 &mdash; which has brought together hundreds of students and scholars each year &mdash; we are proud to bring this tradition to <strong>Lagos</strong> for the very first time.
          </p>
          <p className="about-body">
            The programme runs <strong>from Fajr to Isha</strong>, with structured revision sessions by category, meals provided, international guest scholars from the UK, and a closing certificate ceremony to honour every participant.
          </p>
        </div>
